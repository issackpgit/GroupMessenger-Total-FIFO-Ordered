...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        db.insertWithOnConflict("datatable", null, values, db.CONFLICT_REPLACE);
...
//        String querystr = "SELECT * FROM datatable WHERE key = ?";
//        Cursor c = db.rawQuery(querystr,new String[]{selection});

        Cursor c = db.query("datatable" , null , "key = ?" , new String[]{selection} , null, null, null);
